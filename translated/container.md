...
- [Introducción](#introduction)
    - [Resolución Sin Configuración](#zero-configuration-resolution)
    - [Cuándo Utilizar el Contenedor](#when-to-use-the-container)
- [Vinculación](#binding)
    - [Conceptos Básicos de Vinculación](#binding-basics)
    ...
    - [Vinculación de Primitivos](#binding-primitives)
    - [Vinculación de Variádicos Tipados](#binding-typed-variadics)
    - [Etiquetado](#tagging)
    - [Extensión de Vinculaciones](#extending-bindings)
