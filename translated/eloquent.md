...
- [Convenciones del Modelo Eloquent](#eloquent-model-conventions)
    ...
    - [Valores Predeterminados de Atributos](#default-attribute-values)
    - [Configurando la Estrictez de Eloquent](#configuring-eloquent-strictness)
- [Recuperando Modelos](#retrieving-models)
    - [Colecciones](#collections)
    - [Fragmentando Resultados](#chunking-results)
    - [Fragmentar Usando Colecciones Perezosas](#chunking-using-lazy-collections)
    - [Cursors](#cursors)
    - [Subconsultas Avanzadas](#advanced-subqueries)
- [Recuperando Modelos Únicos / Agregados](#retrieving-single-models)
...
- [Eliminando Modelos](#deleting-models)
    ...
    - [Consultando Modelos Suavemente Eliminados](#querying-soft-deleted-models)
